...
type BlockPadding = { end: number; start: number };
...
function getMessageScrollerScrollable({
  ...
  return {
    ...
    end: contentBottom - viewport.scrollTop - viewport.clientHeight >
      scrollEdgeThreshold,
  };
}
...
function getLastScrollAnchor(items: HTMLElement[]): HTMLElement | null {
...
function getElementScrollTop({
  ...
  if (align === "nearest") {
    ...
    const viewportBottom = viewport.scrollTop +
      viewport.clientHeight -
      contentPadding.end;
...
function getElementTop(element: HTMLElement, viewport: HTMLElement): number {
...
function getElementViewportTop(
  element: HTMLElement,
  viewport: HTMLElement,
): number {
  return (
...
function getBlockPadding(element: HTMLElement): BlockPadding {
...
function getContentBlockPadding(spacer: HTMLElement | null): BlockPadding {
