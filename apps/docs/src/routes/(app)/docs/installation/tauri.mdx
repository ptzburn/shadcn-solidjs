...
If you already have a SolidStart, Vite or Astro project with shadcn-solid set up you can add Tauri by simply following the steps provided [here](https://tauri.app/v1/guides/getting-started/setup/integrate/).
