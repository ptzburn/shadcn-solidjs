...
```bash
npx @ptzburn/shadcn-solidjs@beta add alert-dialog
```
...
For more information about the other components and their props, see the [Kobalte](https://kobalte.dev/docs/core/components/alert-dialog) documentation.
